...
## Bar charts for showing discrete magnitude of values vs attribute on either x or y
day vs traffic
...
## Line chart for showing continues magnitude of values vs attribute for a period of time.
...
2. Poisson Distribution: 
    Discrete Probability Distribution, eg, pattern of customers(independent events/customer don't coordinate with each other while coming) walking into store
3. Binomial Distribution
    N trails with Only 2 possible outcomes, eg: win or loose
4. Bernoulli Distribution (spc case of Binomial Distribution)
...
- Stacked Area: Number of products sold by different departments over time. (line chart also works)
- Stacked Bar chart: magnitude of values vs 1+ attributes
